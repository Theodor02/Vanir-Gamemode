...
function PANEL:Init()
	...
	-- ===================================================================
	-- LEFT: Identity Record (data-panel)
	-- ===================================================================
	...
	self.leftPanel.Paint = function(pnl, w, h)
		...
		draw.SimpleText("CLASSIFIED", "ixImpMenuDiag", w - Scale(10), hH * 0.5, Color(0, 0, 0, math.Round(100 + pulse * 155)), TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
	end
...
function PANEL:PopulateInfo()
	...
	affLabel:SetText("AFFILIATION:  " .. factionName)
